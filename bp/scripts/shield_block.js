...
const KNOCKBACK_TAG = "shield_knock"; // Tag to detect
...
const MONITOR_GAP_TICKS = 3; // Check every 1 tick (as real-time as possible)
    ...
    system.runInterval(() => {
        ...
        for (const dimId of dimensionIdsToQuery) {
            try {
                ...
                // 2. Filter entities with 'shield_knock' tag
