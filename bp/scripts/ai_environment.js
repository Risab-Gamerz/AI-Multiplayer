...
const BlastAvoidRadius = 8;
const ShelterFindRadius = 10;
...
function seekShelter(bot, dimension) {
    ...
    for (let x = -ShelterFindRadius; x <= ShelterFindRadius; x += 2) {
        for (let z = -ShelterFindRadius; z <= ShelterFindRadius; z += 2) {
            for (let y = -2; y <= 2; y++) {
                const checkLoc = {
